            ...
            >
                ...
                <div className="h-20 flex items-center justify-between px-6 border-b border-slate-100 flex-shrink-0 bg-slate-50/50">
                    <div className="flex items-center gap-3">
                        {type === 'user' ? (
                            <>
                                <div className="w-9 h-9 bg-red-600 rounded-lg flex items-center justify-center text-white font-bold text-lg shadow-sm">S</div>
                                <div>
                                    <h1 className="font-bold text-slate-800 leading-none">Smart</h1>
                                    <p className="text-[10px] uppercase tracking-wider text-green-600 font-bold mt-1">Service Point</p>
                                </div>
                            </>
                        ) : (
